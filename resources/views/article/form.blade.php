        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('article.store') }}" method="post" class="pb-4">
                        @csrf
                        <div class="form-group">
                            <x-input type="text" name="title" class="form-control" placeholder="Title" value="{{ request('title') }}" />
                        </div>
                        <div class="form-group">
                            <x-input type="text" name="body" class="form-control" placeholder="Body" value="{{ request('body') }}" />
                        </div>
                        <div class="form-group">
